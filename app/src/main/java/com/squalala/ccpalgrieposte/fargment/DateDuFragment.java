 ...
 * 
 */
public class DateDuFragment extends DialogFragment 
	...
	public static DateDuFragment newInstance(BootstrapButton arrive) {
		DateDuFragment dateDialogFragment = new DateDuFragment();
